...
<body> 
<div class="box-loader"><div class="loader"></div></div><!--box-loader-->
    ...
    <div class="container">
        <nav class="navigation">
            ...
            <ul id="nav-menu">
                ...
                <?php echo (isset($_SESSION['id_user']) || isset($_COOKIE["id_user"])) ? 'User Page <svg style="vertical-align: middle;" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user">
                    <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>' : "Sign Up | Login" ?></a></li>
            </ul>
        </nav>
    </div><!-- /.container -->
</header>