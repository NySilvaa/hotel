...
<section id="testeJson">
        ...
        <div class="container">
            ...
            <section class="img-hotel">
                ...
                <div class="img-hotel-complements">
                    <div class="img-complements-box">
                        <a href="<?php echo $dataHotel["Img"][1]; ?>" data-fancybox="gallery" data-caption="Caption #2"><figure class="img-complement"><img src="<?php echo $dataHotel["Img"][1]; ?>" alt="" srcset=""></figure></a>
                        <a href="<?php echo $dataHotel["Img"][2]; ?>" data-fancybox="gallery" data-caption="Caption #3"><figure class="img-complement"><img src="<?php echo $dataHotel["Img"][2]; ?>" alt="" srcset=""></figure></a>
                    </div>    

                    <div class="img-complements-box">
                        <a href="<?php echo $dataHotel["Img"][3]; ?>" data-fancybox="gallery" data-caption="Caption #4"><figure class="img-complement"><img src="<?php echo $dataHotel["Img"][3]; ?>" alt="" srcset=""></figure></a>
            ...
            <div class="hotel-description">
                ...
                <div class="classification">
                    ...
                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-star"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 
                    ...
                    21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"/></svg> <?php echo $dataHotel["Avaliacoes"]["media"]; ?> ° </span>
    ...
    <section class="avaliacoes" id="comentarios">
        <div class="container">
            <h2 class="avaliacoes-tittle"><svg xmlns="http://www.w3.org/2000/svg" fill="#55331f" width="28" height="28" viewBox="0 0 24 24"  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-star"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"/></svg> <?php echo $dataHotel["Avaliacoes"]["media"]." ° ".count($dataHotel["Avaliacoes"]["comentarios"])." Comentários"; ?></h2>
