...
<main id="register">
    <div class="container">
        <section class="register-wp">
            <section class="forms" style="width: 50%;">
            ...
            <section class="bg-form-video" style="width: 50%;">
                <video src="<?php echo PATH_INTERATIONS; ?>images/bg-video-register.mp4" loop muted autoplay height="1120" width="700"></video>
            </section>
        </section>
    </div><!-- /.container -->
</main>